...
【章節結構】
依 references/phase6-docx-prompts.md §2 完整結構建立。
...
- 圖表從 charts/ 目錄按章節插入
- 附錄 A GRI Content Index 從 references/compliance-checklist.md 對應產生
...
【翻譯規則】
- 專業術語強制查 references/esg-glossary-zh-en.md，譯名必須一致
- 數字、公式、表格結構保持相同
...
| 銜接點 | 動作 |
|-------|------|
| → Phase 6 pdf 輸出 | docx 完稿後，pdf skill 轉檔（見 phase6-pdf-prompts.md） |
