...
【Sheet 結構】
依 references/phase4-xlsx-prompts.md §2 的 14 個工作表清單建立。
...
5. 排放因子若有更新（依 websearch-pending.md 查證結果），更新常數欄並在註解加上「YYYY-MM-DD 因子版本更新」
...
| → Phase 6 docx 組裝 | 圖表來源欄位需可導出為 PNG（用 pptx skill 轉檔，見 phase6-pptx-prompts） |
