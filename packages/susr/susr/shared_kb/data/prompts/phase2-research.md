---
slug: phase2-research-prompts
category: prompt
source: skills/sustainability-report/references/phase2-research-prompts.md
version: "2025-05-25"
language: zh-Hant
...
**前置**：先讀 `checklists/websearch-pending.md` 確認本年度待查項目。本檔案提供查詢模板，輸出整合進 `research-log.md`（Phase 2 產出物）。
...
| → 回填 checklists/websearch-pending.md | 完成查詢後填「最後確認日期 + URL」 |

---

## 7. 年度執行檢查表

- [ ] A 類 4 項全跑完，回填到 `checklists/websearch-pending.md`
- [ ] B 類 3 項至少 2 項有更新確認
- [ ] C 類至少選 5 家 peer 跑完
