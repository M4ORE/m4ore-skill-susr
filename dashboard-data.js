  ...
  "sprintStatus": {
    ...
    "pivotBacklog": {
      ...
      "items": [
        ...
        "🚨 **R3 P0 補強優先序（從 Step 2-B walkthrough 揭露）**：",
        "    [P0a] Ingest tolerance layer — 真實 markdown 兩種 schema mismatch（英文 Literal token / PyYAML auto date）一定要 normalize 才能 ingest",
        "    [P0b] 新增 IRO 建立 tool（link_topic_to_iro 或 score_topic_dual_axis 同步建 IRO 骨架）— I1 invariant 9/9 fail",
        "    [P0c] materiality_tier 二套標準收斂 — frontmatter explicit vs _classify_tier 計算，二擇一",
